...
while run:
    ...
    if len(EnemiesList.enemies) <= 0:
        screen.blit(fontLarge.render("Game Over!", True, (255, 255, 255)),
                    (gameConfigs["width"]/2 - 240, gameConfigs["height"]/2 - 100))

    elif player.lifes <= 0:
        pygame.mixer.music.load("assets/audios/gunshot2.ogg")
        pygame.mixer.music.play()
        screen.blit(fontLarge.render("Damn!", True, (255, 255, 255)),
                    (gameConfigs["width"]/2 - 240, gameConfigs["height"]/2 - 100))
    ...
    enemiesText = fontSmall.render(
        "Inimigos: "+str(len(EnemiesList.enemies)), True, (255, 255, 255))
    # screen.blit(enemiesText, (10, 145))

    timeText = fontSmall.render(
        "Tempo: "+str(pygame.time.get_ticks()/1000), True, (255, 255, 255))
